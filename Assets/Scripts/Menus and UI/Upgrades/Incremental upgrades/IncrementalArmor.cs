...
public class IncrementalArmor : MonoBehaviour
{
    ...
    public void Upgrade()
    {
        ...
        if (controller.credits.VerifyInt(controller.pCredits) >= creditsCost.VerifyInt(pCreditsCost))
        {
            ...
            controller.armorLevel.VerifyInt(controller.pArmorLevel);

            controller.pArmorLevel++;
            controller.armorLevel.Reset(controller.pArmorLevel);
