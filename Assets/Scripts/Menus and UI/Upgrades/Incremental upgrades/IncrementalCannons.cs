...
public class IncrementalCannons : MonoBehaviour
{
    ...
    public void Upgrade()
    {
        ...
        if(controller.credits.VerifyInt(controller.pCredits) >= creditsCost.VerifyInt(pCreditsCost))
        {
            ...
            controller.cannonLevel.VerifyInt(controller.pCannonLevel);

            controller.pCannonLevel++;
            controller.cannonLevel.Reset(controller.pCannonLevel);
